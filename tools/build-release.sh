#!/usr/bin/env bash
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)";PLUGIN="$ROOT/19-unified-notifications";BUILD="$ROOT/build";STAGE="$BUILD/stage";NAME="19-sabri-unified-notifications-3.0.4.zip";CANONICAL="unified-notifications-19"
