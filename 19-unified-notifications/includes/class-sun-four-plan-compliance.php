...
final class SUN_Four_Plan_Compliance {
	...
	public static function top20_capabilities() {
		return array(
			...
			'CV-102'=>array('name'=>'Correction alert','surface'=>'Publishing correction/retraction facts','guardrail'=>'severity-based'),
			'CV-103'=>array('name'=>'Security alert','surface'=>'Security.* events','guardrail'=>'trusted-recovery-path'),
			'CV-104'=>array('name'=>'Creator bulletin','surface'=>'Social.CreatorBulletinPublished','guardrail'=>'opt-in-frequency-cap-report'),
	...
	/**
	 * Factual event shapes expected from native owners. File 19 never becomes
	 * the source-of-truth for the appointment/publication/security object.
	 *
	 * @return array<string,array<string,mixed>>
	 */
	public static function event_catalog() {
		return array(
			...
			'AccountAuthenticationSucceeded.v1'=>array('owner'=>2,'category'=>'security','priority'=>'normal'),
			'AccountAuthenticationFailed.v1'=>array('owner'=>2,'category'=>'security','priority'=>'high'),
			'PasswordResetCompleted.v1'=>array('owner'=>2,'category'=>'security','priority'=>'critical'),
			'AuthSessionRevoked.v1'=>array('owner'=>2,'category'=>'security','priority'=>'high'),
			'GoogleAccountLinked.v1'=>array('owner'=>2,'category'=>'security','priority'=>'high'),
			'GoogleAccountUnlinked.v1'=>array('owner'=>2,'category'=>'security','priority'=>'high'),
			'PasskeyRegistered.v1'=>array('owner'=>2,'category'=>'security','priority'=>'high'),
			'PasskeyAuthenticated.v1'=>array('owner'=>2,'category'=>'security','priority'=>'normal'),
			'PasskeyRevoked.v1'=>array('owner'=>2,'category'=>'security','priority'=>'critical'),
