...
final class SUN_Plugin {
	...
	public function boot(){
		...
		$this->renderer=new SUN_Renderer($this->notifications,$this->preferences,$this->subscriptions,$this->wellbeing,$this->auth);
		...
		$router=new SUN_Router($this->renderer,$this->notifications,$this->auth);
	...
	/** @return void */ public function register_cron_interval(){add_filter('cron_schedules',static function($items){$items['sun_every_minute']=array('interval'=>60,'display'=>__('Every minute (File 19)','sabri-unified-notifications'));return $items;});}
	...
	/** @return SUN_Wellbeing */ public function wellbeing(){return $this->wellbeing;}
