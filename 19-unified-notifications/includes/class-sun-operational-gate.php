...
final class SUN_Operational_Gate {
	/** @return bool */
	private static function file20_safe_mode() {
		if ( class_exists( 'Sabri\\UnifiedShell\\SafeMode' ) && is_callable( array( 'Sabri\\UnifiedShell\\SafeMode', 'disabled' ) ) ) {
			try {
		...
		return (bool) apply_filters( 'sun_file20_safe_mode_active', false );
	}
