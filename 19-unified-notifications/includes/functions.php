 ...
 * Cross-user writes are denied unless a host explicitly grants a scoped override.
 *
 * @param int $user_id User ID.
 * @param string $scope_type Scope type.
 * @param string $scope_id Domain source identifier.
 * @param bool $enabled Enabled.
 * @param string $frequency immediate|daily|weekly.
 * @param int|null $version Optional optimistic version.
...
function sun_set_notification_subscription( $user_id, $scope_type, $scope_id, $enabled = true, $frequency = 'immediate', $version = null ) {
	...
	$allowed = is_user_logged_in() && get_current_user_id() === $user_id;
