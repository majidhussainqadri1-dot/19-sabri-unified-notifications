...
define( 'SUN_VERSION', '3.0.4' );
define( 'SUN_DB_VERSION', '3.0.2' );
...
require_once SUN_PATH . 'includes/class-sun-cross-file-contracts.php';
require_once SUN_PATH . 'includes/class-sun-legacy-migration.php';
