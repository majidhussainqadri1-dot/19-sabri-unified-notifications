...
| Automated QA | Prior post-hardening run `35877312271` passed all PHP 8.3/8.4 gates; final webhook replay hardening requires one new exact-head run before merge |
