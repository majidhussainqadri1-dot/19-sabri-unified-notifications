...
| Automated QA | Post-hardening branch run `35877312271` passed all PHP 8.3/8.4 gates; frozen-checksum exact-head re-verification remains the final repository gate before merge |
